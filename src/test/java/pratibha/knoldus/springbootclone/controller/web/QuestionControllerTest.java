...
class QuestionControllerTest extends AbstractControllerTest {
    ...
    void getQuestionById() throws Exception {
        mvc.perform(get(ControllerConstants.QUESTIONS_PATH + "/" + EXISTED_QUESTION_ID))
    ...
    void getQuestionByIdNotFound() throws Exception {
        ...
        mvc.perform(get(ControllerConstants.QUESTIONS_PATH + "/" + NON_EXISTED_QUESTION_ID))
                .andExpect(status().isOk())
                .andExpect(content().contentType(CONTENT_TYPE))
    ...
    void getCreationForm() throws Exception {
        mvc.perform(get(ControllerConstants.QUESTIONS_PATH + "/new"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(CONTENT_TYPE));
    }
    ...
    void deleteQuestion() throws Exception {
        ...
        mvc.perform(delete(ControllerConstants.QUESTIONS_PATH + "/" + EXISTED_QUESTION_ID).with(csrf()))
