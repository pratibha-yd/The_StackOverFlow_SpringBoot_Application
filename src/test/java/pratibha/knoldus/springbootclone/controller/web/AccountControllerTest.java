...
class AccountControllerTest extends AbstractControllerTest {
    ...
    public void getAccountByIdNotFound() throws Exception {
        ...
        mvc.perform(get(ControllerConstants.ACCOUNTS_PATH + "/" + NON_EXISTED_USER_ID))
    ...
    public void getAccountById() throws Exception {
        mvc.perform(get(ControllerConstants.ACCOUNTS_PATH + "/" + EXISTED_USER_ID))
            .andExpect(status().isOk())
            .andExpect(content().contentType(CONTENT_TYPE))
    ...
    public void getCreationForm() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get(ControllerConstants.LOGIN_PATH))
                .andExpect(status().isOk())
                .andExpect(content().contentType(CONTENT_TYPE));
    }
    ...
    public void postAccount() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post(ControllerConstants.REGISTRATION_PATH)
    ...
    public void getEditForm() throws Exception {
        mvc.perform(get(String.format("%s/edit/%d", ControllerConstants.ACCOUNTS_PATH, EXISTED_USER_ID)))
                .andExpect(status().isOk())
                .andExpect(content().contentType(CONTENT_TYPE))
                .andExpect(content()
    ...
    public void deleteAccount() throws Exception {
        ...
        mvc.perform(delete(ControllerConstants.ACCOUNTS_PATH + "/" + EXISTED_USER_ID).with(csrf()))
